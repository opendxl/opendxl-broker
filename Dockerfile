...
# libwebsockets
RUN cd /tmp \
    && wget https://github.com/opendxl-community/libwebsockets/archive/v3.1-stable-opendxl-1.tar.gz \
    && tar xvzf v3.1-stable-opendxl-1.tar.gz \
    && cd libwebsockets-3.1-stable-opendxl-1 \
